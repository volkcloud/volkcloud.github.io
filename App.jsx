...
const animaCardData = {
    ...
    text: <React.Fragment>R&amp;D teams build cloud apps 10x faster with Anima. <br />Turn Figma / Adobe XD / Sketch to React code.<br />We make developers &amp; designers happier.</React.Fragment>,
};
