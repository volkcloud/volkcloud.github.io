    ...
    <div className="anima-card">
      ...
      <div className="logos-frame">
        ...
        <div className="social">
          <SocialIcon
            icon={<AntDesignIcons.MediumOutlined />}
            url="https://animaapp.medium.com/"
          />
          <SocialIcon
            icon={<AntDesignIcons.YoutubeFilled />}
            url="https://www.youtube.com/c/animaapp"
          />
          <SocialIcon
            icon={<AntDesignIcons.GithubFilled />}
            url="https://github.com/AnimaApp"
          />
        </div>
      </div>
    </div>
